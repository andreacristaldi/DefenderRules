...
public class DefenderRules
{
    ...
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("Cybersec4.com DefenderRules\n");
...
<body>
    <h1>Top 30 Global Threats Signatures Stats Chart</h1>
...
<body>
    <h1>Threat Groups Top 10 Signatures Stats Chart</h1>");
